...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900">
        <a href="#" onclick="freshConv()" style="position: absolute; top: 20px; left: 20px; background-color: #ef4444; color: white; border-radius: 8px; padding: 8px 18px; z-index: 10;">Refresh</a>
                ...
                <div class="focal-outline scale-100 p-3 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex focusw:outline focusw:outline-2 focusw:outline-red-500" style="position: absolute; bottom: 200px; width: 100%;">
                    ...
                    {{-- {{route('generate.qr')}} --}}
                        ...
                        <label class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed" style="display: block; text-align: center; padding: 10px;" for="title"><strong>Your Name</strong></label>
                            ...
                            <br>
                        <input type="submit" class="focal-outline font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" style="cursor: pointer; display: block; margin: 0 auto; padding: 10px;" value="Proceed" id="submit-url" />
                    </form>
                </div>
            </div>
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center selection:bg-red-500 selection:text-white">
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="boxc">
                    <div class="flex" style="flex-direction: row-reverse; float: right;">
                        <div>
                ...
                <div class="boxr">
                    <div class="p-6">
                        <div class="scale-100 p-3 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex focusw:outline focusw:outline-2 focusw:outline-red-500 inpxb">
                            ...
                            {{-- {{route('generate.qr')}} --}}
                                @csrf
                                <textarea type="text" rows="1" onkeyup="txAdjust(this)" class="bdls-input wwide text-gray-500 dark:text-gray-400 text-sm" required name="message" autocomplete="off" placeholder="Write..."></textarea>
...
// var config = document.getElementById('config');
            // config.addEventListener('click', switchCmonfig, false);
            // const currConfig = localStorage.getItem('config');
            // if (currConfig) {
            //     // document.documentElement.setAttribute('data-theme', currentTheme);
            //     //use current config to set the function
            //     if (currentTheme === 'enter') {
            //         config.checked = true;
            //     }
            // }
            function switchConfig(e) { alert('yay');
                // if (e.target.checked) {
